  ...
  const contactInfo = [
    {
      icon: Phone,
      title: "Phone Number",
      details: ["+91 9982451367", "+91 9982451368"],
      color: "bg-blue-50",
    ...
    },
    {
      icon: Mail,
      title: "Email Address",
      details: ["info@srichaitanya.edu", "admissions@srichaitanya.edu"],
      color: "bg-red-50",
            ...
            <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-2xl p-6 md:p-8">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-gray-700">
                  ...
                  <span className="text-sm md:text-base">Toll Free: 1800-123-4567</span>
                </div>
                <div className="flex items-center gap-3 text-gray-700">
                  <Mail className="w-5 h-5 text-red-600" />
                  <span className="text-sm md:text-base">support@srichaitanya.edu</span>
                </div>
              </div>
            </div>
